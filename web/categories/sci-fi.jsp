...
Sci-Fi Films...<table id="productTable">
                    <tr>
                        <td class="lightBlue">
                            <img src="Products/Inception.jpg" alt="image" height="20%" width="50%"/>
                        </td>
                        <td class="lightBlue">
                    ...
                    <tr>
                        <td class="white">
                            <img src="Products/E.T.jpg" alt="image" height="20%" width="50%">
                        </td>
                        <td class="white">
                            <stong>E.T</stong>
                            <br>
                     ...
                     <td class="white">
                            <img src="Products/Super 8.jpg" alt="image" height="20%" width="50%">
                        </td>
                        <td class="white">
                        ...
                        <td class="white"><p>During the summer of 1979, a group of friends witness a train
                             crash and investigate subsequent unexplained events in their small town.</p></td>
                        <td class="white">
                            <form action="#" method="post">
                                <input type="submit" value="purchase button">
                            </form>
                    ...
                    <tr>
                        <td class="white">
                            <img src="Products/The Matrix.jpg" alt="image" height="20%" width="20%">
                        </td>
                        <td class="white">
